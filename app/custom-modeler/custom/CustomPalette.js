...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  assign(actions, {
    ...
    'custom-letterD': createAction(
        'custom:letterD', 'custom', 'icon-custom-letter','','', 'https://upload.wikimedia.org/wikipedia/commons/1/13/Font_D.svg'
    ),
    'custom-letterE': createAction(
        'custom:letterE', 'custom', 'icon-custom-letter','','', 'https://upload.wikimedia.org/wikipedia/commons/d/dd/Font_E.svg'
    ),
    'custom-letterF': createAction(
        'custom:letterF', 'custom', 'icon-custom-letter','','', 'https://upload.wikimedia.org/wikipedia/commons/1/1f/Font_F.svg'
    ),
    'custom-separator': {
      group: 'custom',
      separator: true
